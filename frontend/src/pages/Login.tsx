...
export const Login: React.FC<LoginProps> = ({
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-rose-500/20 rounded-full blur-[120px] pointer-events-none" />
            ...
            >
                        ...
                        <div className="w-full space-y-3 pt-2">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 bg-slate-800/90 border border-slate-700 rounded-xl text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-brand-500 transition-colors"
                                />
                            </div>
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-xs text-slate-400">or use your email and password</span>
                        ...
                        <div className="w-full space-y-3 pt-2">
                            ...
                            <button
                                type="submit"
                                className="w-full py-3 mt-2 bg-gradient-to-r from-brand-600 via-rose-600 to-amber-500 text-white font-semibold text-xs sm:text-sm rounded-xl shadow-lg shadow-brand-600/30 hover:shadow-brand-500/50 hover:scale-[1.01] transition-all uppercase tracking-wider"
                            >
                                Sign In
                            </button>
                        </div>
                ...
                >
                    ...
                    <div
                        className={`bg-gradient-to-br from-brand-600 via-rose-600 to-amber-600 text-white relative -left-full h-full w-[200%] transition-transform duration-700 ease-in-out ${isActive ? 'translate-x-1/2' : 'translate-x-0'
                            }`}
                    >
                        {/* Toggle Left Panel (shown when Sign Up active -> allows switching back to Sign In) */}
                        <div
                            className={`absolute top-0 flex flex-col items-center justify-center px-8 text-center h-full w-1/2 transition-transform duration-700 ease-in-out ${isActive ? 'translate-x-0' : '-translate-x-full'
                                }`}
                        >
                            ...
                            <p className="text-xs text-rose-100 leading-relaxed max-w-xs mb-6">
                                Enter your personal details to access all of DD Events Group features.
                            </p>
                            <button
                                type="button"
                        ...
                        {/* Toggle Right Panel (shown when Sign In active -> allows switching to Sign Up) */}
                        <div
                            className={`absolute top-0 right-0 flex flex-col items-center justify-center px-8 text-center h-full w-1/2 transition-transform duration-700 ease-in-out ${isActive ? 'translate-x-full' : 'translate-x-0'
                                }`}
                        >
                            <h1 className="font-serif text-3xl font-bold mb-2">Hello, Friend!</h1>
                            <p className="text-xs text-rose-100 leading-relaxed max-w-xs mb-6">
                                Register with your personal details to start planning your dream event with us.
                            </p>
                            <button
                                type="button"
                                onClick={() => {
